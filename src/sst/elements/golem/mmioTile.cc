    ...
    Component(id)
{
    ...
    array = loadUserSubComponent<ComputeArray>("array", ComponentInfo::SHARE_NONE, clockTC, new SST::Event::Handler<MMIOTile>(this, &MMIOTile::handleArrayEvent), &arrayIns, &arrayOuts);
    if ( !array ) {
